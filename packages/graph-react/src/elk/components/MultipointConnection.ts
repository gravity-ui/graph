...
import { Path2DRenderStyleResult } from "@gravity-ui/graph";
import { BlockConnection } from "@gravity-ui/graph";
import { isPointInStroke } from "@gravity-ui/graph";
import { HitBoxData } from "@gravity-ui/graph";
import { curvePolyline } from "@gravity-ui/graph";
import { trangleArrowForVector } from "@gravity-ui/graph";
