...
**See also:** [Manual Groups story](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/manual.stories.tsx) — fixed colored zones.
...
**See also:** [Basic Groups](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/default.stories.tsx), [Large graph](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/large.stories.tsx).
...
**See also:** [Collapsible Groups story](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/collapsible.stories.tsx).
...
**See also:** [Extended Groups story](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/extended.stories.tsx).
...
| ----------------------------------------------------------------- | ----------------------------------------------------- |
| [default](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/default.stories.tsx)         | Automatic groups from block properties                |
| [large](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/large.stories.tsx)             | Many blocks / groups                                  |
| [manual](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/manual.stories.tsx)           | Fixed non-draggable zones                             |
| [extended](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/extended.stories.tsx)       | Custom group class + extra fields                     |
| [collapsible](https://github.com/gravity-ui/graph/blob/v2/apps/storybook/src/stories/canvas/groups/collapsible.stories.tsx) | `CollapsibleGroup`, dblclick, `group-collapse-change` |
