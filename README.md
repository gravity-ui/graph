...
import { GraphCanvas, GraphBlock } from "@gravity-ui/graph/react-components";
```
...
```typescript
import { EAnchorType, Graph } from "@gravity-ui/graph";
import { GraphCanvas, GraphState, GraphBlock, useGraph } from "@gravity-ui/graph/react-components";
...
3. Rendering
   ...
   - [ReactLayer](docs/rendering/reactLayer.md)
