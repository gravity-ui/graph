import { CSSVariableType, type CSSVariablesLayerProps, type CSSVariableMappings } from "./types";
...
export const CSS_VARIABLE_MAPPINGS: CSSVariableMappings = [
  // Canvas colors
  { cssVariable: "--graph-canvas-background", graphPath: "canvas.layerBackground", typeConverter: CSSVariableType.COLOR },
  { cssVariable: "--graph-canvas-below-background", graphPath: "canvas.belowLayerBackground", typeConverter: CSSVariableType.COLOR },
  ...
  { cssVariable: "--graph-block-selected-border", graphPath: "block.selectedBorder", typeConverter: CSSVariableType.COLOR },

  // Anchor colors
  { cssVariable: "--graph-anchor-background", graphPath: "anchor.background", typeConverter: CSSVariableType.COLOR },
  { cssVariable: "--graph-anchor-selected-border", graphPath: "anchor.selectedBorder", typeConverter: CSSVariableType.COLOR },

  // Connection colors
  { cssVariable: "--graph-connection-background", graphPath: "connection.background", typeConverter: CSSVariableType.COLOR },
  { cssVariable: "--graph-connection-selected-background", graphPath: "connection.selectedBackground", typeConverter: CSSVariableType.COLOR },

  // Connection label colors
  { cssVariable: "--graph-connection-label-background", graphPath: "connectionLabel.background", typeConverter: CSSVariableType.COLOR },
  { cssVariable: "--graph-connection-label-hover-background", graphPath: "connectionLabel.hoverBackground", typeConverter: CSSVariableType.COLOR },
  { cssVariable: "--graph-connection-label-selected-background", graphPath: "connectionLabel.selectedBackground", typeConverter: CSSVariableType.COLOR },
  { cssVariable: "--graph-connection-label-text", graphPath: "connectionLabel.text", typeConverter: CSSVariableType.COLOR },
  { cssVariable: "--graph-connection-label-hover-text", graphPath: "connectionLabel.hoverText", typeConverter: CSSVariableType.COLOR },
  { cssVariable: "--graph-connection-label-selected-text", graphPath: "connectionLabel.selectedText", typeConverter: CSSVariableType.COLOR },

  // Selection colors
  { cssVariable: "--graph-selection-background", graphPath: "selection.background", typeConverter: CSSVariableType.COLOR },
  ...
  // Text constants
  { cssVariable: "--graph-text-base-font-size", graphPath: "text.BASE_FONT_SIZE", typeConverter: CSSVariableType.FLOAT },
 ...
 */
export const SUPPORTED_CSS_VARIABLES = new Set(
  CSS_VARIABLE_MAPPINGS.map(mapping => mapping.cssVariable)
);
