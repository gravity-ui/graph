...
> {
  ...
  protected afterInit(): void {
    ...
    this.graphOn("camera-change", this.requestRender);
  ...
  protected unmountLayer(): void {
    // No need to manually remove event listeners as they are handled by the AbortController
    // in the parent class when super.unmount() is called
